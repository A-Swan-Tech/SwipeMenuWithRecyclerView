...
import com.ahtesham.swipemenuwithrecyclerview.OnActivityTouchListener;
...
public class MainTouchListener implements RecyclerView.OnItemTouchListener, OnActivityTouchListener {
    ...
    public MainTouchListener(Activity a, RecyclerView recyclerView) {
        this.act = a;
    ...
    public MainTouchListener setSwipeable(int foregroundID, int backgroundID) {
        this.swipeable = true;
